...
const Home = () => {
  return (
      <div id="home" className="flex flex-row justify-around bg-white dark:bg-gray-900 font-display:swap">
      <div className="flex flex-col w-6/6 sm:w-3/6 h-fit sm:h-40 md:h-48 lg:h-48 xl:h-fit mt-28 sm:mt-64 md:mt-64 lg:mt-80 xl:mt-48 mx-3 sm:mx-4 md:mx-8 lg:mx-4 xl:mx-8 justify-start sm:justify-center items-start sm:items-center absolute sm:relative">
        <div className="">
          ...
          <div className="flex flex-row justify-around ">
            ...
            <p className="font-extenda90 text-gray-500 sm:text-gray-600 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl extraTight">
              WEB <br /> DEVELOPER
            </p>
          </div>
        </div>
