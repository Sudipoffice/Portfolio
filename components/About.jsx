...
const About = () => {
  return (
    <div id="about" className="flex flex-col sm:flex-row pt-20 sm:pt-28 md:pt-36 px-1 sm:px-4 md:px-20 h-fit sm:h-screen bg-slate-200 dark:bg-gray-800">
      <div className="flex flex-col sm:w-3/6 md:w-3/5 ">
        ...
        <div className="my-2 sm:my-5 px-4 sm:px-0 text-xs sm:text-sm md:text-md lg:text-base font-light text-black dark:text-gray-300 z-10">
